...
const SDL_Color StyleManager::gray			= {30,  40,  40,  1};
const SDL_Color StyleManager::slate			= {61,  84,  87,  1};
const SDL_Color StyleManager::lightSlate	= {149, 171, 173, 1};
const SDL_Color StyleManager::darkSlate		= {35,  45,  46,  1};
