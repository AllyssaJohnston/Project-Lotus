...
enum EKeyboardInput 
{
	...
	EKeyboardInput_LEFT, EKeyboardInput_RIGHT, EKeyboardInput_UP, EKeyboardInput_DOWN,
	EKeyboardInput_Q, EKeyboardInput_W, EKeyboardInput_E, EKeyboardInput_R, EKeyboardInput_T, EKeyboardInput_Y,
	EKeyboardInput_U, EKeyboardInput_I, EKeyboardInput_O, EKeyboardInput_P, EKeyboardInput_A, EKeyboardInput_S,
	EKeyboardInput_D, EKeyboardInput_F, EKeyboardInput_G, EKeyboardInput_H, EKeyboardInput_J, EKeyboardInput_K,
	EKeyboardInput_L, EKeyboardInput_Z, EKeyboardInput_X, EKeyboardInput_C, EKeyboardInput_V, EKeyboardInput_B,
	EKeyboardInput_N, EKeyboardInput_M,
	EKeyboardInput_1, EKeyboardInput_2, EKeyboardInput_3, EKeyboardInput_4, EKeyboardInput_5, EKeyboardInput_6,
	EKeyboardInput_7, EKeyboardInput_8, EKeyboardInput_9, EKeyboardInput_0,
	EKeyboardInput_SHIFT, EKeyboardInput_CTRL, EKeyboardInput_CAPS, EKeyboardInput_ENTER, EKeyboardInput_ESC,
	EKeyboardInput_SPACE_BAR,
	EKeyboardInput_MOUSE_LEFT, EKeyboardInput_MOUSE_MIDDLE, EKeyboardInput_MOUSE_RIGHT,
	EKeyboardInput_NONE,
	EKeyboardInput_MAX
};
...
static const std::vector<EMiniGameState> allMiniStates = { EMiniGameState_PLAYER_WAIT_FOR_MOVE_INPUT, EMiniGameState_PLAYER_MOVE_CHARACTER, EMiniGameState_PLAYER_WAIT_FOR_ACTION_INPUT,
		EMiniGameState_PLAYER_WAIT_FOR_ATTACK_OPTION_INPUT, EMiniGameState_PLAYER_WAIT_FOR_ATTACK_DIRECTION_INPUT, EMiniGameState_PLAYER_WAIT_FOR_ATTACK_TILE_INPUT,
		EMiniGameState_PLAYER_WAIT_FOR_ATTACK_CHARACTER_INPUT, EMiniGameState_PLAYER_COMPLETE_ACTION_ATTACK, EMiniGameState_PLAYER_COMPLETE_ACTION_DEFEND, EMiniGameState_PLAYER_COMPLETE_ACTION_HEAL,
		EMiniGameState_ENEMY_MOVE_CHARACTER, EMiniGameState_ENEMY_TAKE_ACTION, EMiniGameState_CHARACTER_STUNNED, EMiniGameState_BUFFER };
