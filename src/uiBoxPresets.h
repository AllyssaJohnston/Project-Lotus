...
struct MiniGameCharacterBoxPreset : public TextBoxPreset
{
	...
	MiniGameCharacterBoxPreset(int characterIndex, ECombatCharacterType characterType,	bool showDuringAllCharacters, EUIBoxValueToDisplay characterStatToDisplay,	std::vector <EMiniGameState> miniGameStateWhenToShowList);
	...
	MiniGameCharacterBoxPreset(int characterIndex, ECombatCharacterType characterType,	bool showDuringAllCharacters, EUIBoxValueToDisplay characterStatToDisplay);
...
struct MiniGamePlayerAttackBoxPreset : public TextBoxPreset { MiniGamePlayerAttackBoxPreset(int characterIndex, bool showDuringAllCharacters, EUIBoxValueToDisplay characterStatToDisplay, int attackNum, ECombatAttackCategoryType attackCategory, std::vector <EMiniGameState> miniGameStateWhenToShowList); };
...
struct MiniGameCharacterImageBoxPreset : public ImageBoxPreset 
{
	...
	MiniGameCharacterImageBoxPreset(int characterIndex, ECombatCharacterType characterType,	bool showDuringAllCharacters,	std::vector <EMiniGameState> miniGameStateWhenToShowList);
};
...
struct MiniGameCharacterShapeBoxPreset : public ShapeBoxPreset 
{
	...
	MiniGameCharacterShapeBoxPreset(EShapeBoxClass type, int characterIndex, ECombatCharacterType characterType,	bool showDuringAllCharacters, std::vector <EMiniGameState> miniGameStateWhenToShowList);
	MiniGameCharacterShapeBoxPreset(EShapeBoxClass type, std::vector <EMiniGameState> miniGameStateWhenToShowList);
};

struct MiniGamePlayerAttackShapeBoxPreset : public ShapeBoxPreset { MiniGamePlayerAttackShapeBoxPreset(EShapeBoxClass type, int characterIndex, bool showDuringAllCharacters, int attackNum, ECombatAttackCategoryType attackCategory, std::vector <EMiniGameState> miniGameStateWhenToShowList); };
