...
void createMainMenu(MenuManager& menuManager, const ScreenObject& screen)
{
	...
	int maxWidth = 200;
	int maxHeight = 100;
	mainMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_KEYBOARD), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, Hitbox(CoordsX1Y1WidthHeight(levelChunkWidth - maxWidth, 0, maxWidth, maxHeight)), Edges(3, 0, 0, 0)), fontFileName, TextBoxSizeInfo(12, 12), TextBoxColorInfo(hintBlue)), false);
...
void createMainGameMenu(MenuManager& menuManager, const ScreenObject& screen)
{
	...
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_LEVEL_NUMBER), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_CENTER, maxWidth, maxHeight, Edges()), fontFileName, TextBoxSizeInfo(16), TextBoxColorInfo(hintBlue)), false, uLine1);
	...
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_KEYS),		 ETextBoxFunction_NO_FUNCTION, UIPositionInfo(	EUIPositionAlign_CENTER, EUIPositionAlign_CENTER,	maxWidth,	maxHeight,	Edges()), fontFileName, TextBoxSizeInfo(12), TextBoxColorInfo(hintBlue)), false,	uLine2);
	...
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_TARGETS),		 ETextBoxFunction_NO_FUNCTION, UIPositionInfo(	EUIPositionAlign_CENTER, EUIPositionAlign_CENTER,	maxWidth,	maxHeight,	Edges()), fontFileName, TextBoxSizeInfo(12), TextBoxColorInfo(hintBlue)), false,	uLine2);
	...
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_COLLECTIBLES), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(	EUIPositionAlign_CENTER, EUIPositionAlign_CENTER,	maxWidth,	maxHeight,	Edges()), fontFileName, TextBoxSizeInfo(12), TextBoxColorInfo(hintBlue)), false,	uLine2);
	...
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_ENEMIES_LEFT), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(	EUIPositionAlign_CENTER, EUIPositionAlign_CENTER,	maxWidth,	maxHeight,	Edges()), fontFileName, TextBoxSizeInfo(12), TextBoxColorInfo(hintBlue)), false,	uLine2);
	...
	maxWidth = 200;
	maxHeight = 100;
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_KEYBOARD), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, Hitbox(CoordsX1Y1WidthHeight(levelChunkWidth - maxWidth, 0, maxWidth, maxHeight)), Edges(10, 0, 0, 0)), fontFileName, TextBoxSizeInfo(12), TextBoxColorInfo(hintBlue)), false);
	...
	// slash
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_SLASH_KEY), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(		EUIPositionAlign_CENTER,	EUIPositionAlign_CENTER,	100, 60, Edges()), fontFileName, TextBoxSizeInfo(leftTextSize), TextBoxColorInfo(hintBlue)), false, lowerLeftHUDBlock);
	...
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_PROJECTILE_HORIZONTAL_KEY),	ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_CENTER, EUIPositionAlign_TOP, 100, 60, Edges()), fontFileName, TextBoxSizeInfo(leftTextSize), TextBoxColorInfo(hintBlue)), false, projectileKeys);
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_PROJECTILE_VERTICAL_KEY),		ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_CENTER, EUIPositionAlign_TOP, 100, 60, Edges()), fontFileName, TextBoxSizeInfo(leftTextSize), TextBoxColorInfo(hintBlue)), false, projectileKeys);
	...
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_MOVEMENT_LEFT_KEY),		ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_CENTER, EUIPositionAlign_TOP, maxWidth, 60, Edges()),			fontFileName, TextBoxSizeInfo(rightTextSize), TextBoxColorInfo(hintBlue)), false, movementArrowTextGrid);
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_MOVEMENT_UP_KEY),			ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_CENTER, EUIPositionAlign_TOP, maxWidth, 60, Edges()),			fontFileName, TextBoxSizeInfo(rightTextSize), TextBoxColorInfo(hintBlue)), false, movementArrowTextGrid);
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_MOVEMENT_RIGHT_KEY),		ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_CENTER, EUIPositionAlign_TOP, maxWidth, 60, Edges()),			fontFileName, TextBoxSizeInfo(rightTextSize), TextBoxColorInfo(hintBlue)), false, movementArrowTextGrid);
	lowerRightHUDBlock->mpSubElems.push_back(movementArrowTextGrid);
	movementArrowTextGrid = nullptr;

	// reset level text
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_LEVEL_RESET_KEY),			ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_CENTER, EUIPositionAlign_TOP, 100, 60, Edges(3, 0, 0, 0)), fontFileName, TextBoxSizeInfo(rightTextSize), TextBoxColorInfo(hintBlue)), false, lowerRightHUDBlock);

	//reset checkpoint text
	mainGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CHECKPOINT_RESET_KEY),	ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_CENTER, EUIPositionAlign_TOP, 100, 60, Edges(3, 0, 0, 0)), fontFileName, TextBoxSizeInfo(rightTextSize), TextBoxColorInfo(hintBlue)), false, lowerRightHUDBlock);
...
void createMiniGameMenu(MenuManager& menuManager, const ScreenObject& screen,  MiniGameWorldData& worldData)
{
	...
	// keyboard debug HUD
	miniGameMenuPage->addBox(new TextBox(GameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_KEYBOARD), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, Hitbox(CoordsX1Y1WidthHeight(1200, 0, 200, 50)), Edges(3, 0, 0, 0)), font, TextBoxSizeInfo(12), white), false);
	...
	miniGameMenuPage->addBox(new TextBox(MiniGamePlayerBoxPreset(ECharacterStatBoxValueToDisplay_CHARACTER_NAME, whenToShow), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_CENTER, EUIPositionAlign_TOP, panelWidth, panelHeadingHeight / 2, Edges(18, 8, 0, 0)), font, TextBoxSizeInfo(20), black), false, characterOptionsHeadingBlock);
	...
	miniGameMenuPage->addBox(new TextBox(MiniGameStatBoxPreset(EGameStatBoxValueToDisplay_MINI_GAME_DEBUG_LINE), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, screen.mGameLevelChunkWidth - 15, 50, Edges()), font, TextBoxSizeInfo(detailText , detailText), darkPink), false, debugStatLine);
...
void createMiniGameCharacterStatsMenu(MenuManager& menuManager, const ScreenObject& screen, MiniGameWorldData& worldData)
{
	...
	UIBlock* statBlock = new UIBlock(Hitbox(CoordsX1Y1WidthHeight(curX, curY, maxWidth, maxHeight)), EUIPositionAlign_LEFT, EUIPositionAlign_TOP, EDirection_RIGHT, EDirection_DOWN, true, 2, !fill, !fill, Edges(), 0, panelColor, "mini game top line");
	// level
	miniGameMenuPage->addBox(new TextBox(MiniGameStatBoxPreset(EGameStatBoxValueToDisplay_CUR_LEVEL_NUMBER), ETextBoxFunction_NO_FUNCTION, UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, maxWidth, maxHeight / 4, Edges(2, 0, 0, 0)), font, TextBoxSizeInfo(headingSize), colors), false, statBlock);
	// characters
	...
	if (worldData.getStage()->mGrid.isSetUp())
	{
		...
		for (int count = 0; count < combatManager.getAllCharacters().size(); count++)
		{
			...
			miniGameMenuPage->addBox(new TextBox(MiniGameCharacterBoxPreset(count, true, "HP: "),											ETextBoxFunction_NO_FUNCTION,	UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, maxWidth,		maxHeight / 4, Edges(0,			3,			0, 0)), font, TextBoxSizeInfo(detailSize),  colors), false, curTextBarBlock);
			miniGameMenuPage->addBox(new HealthBox(HealthBoxPreset(			count,		 ECharacterStatBoxValueToDisplay_CHARACTER_HEALTH),									UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, maxWidth - 50,	maxHeight / 4, Edges(0,			3,			0, 0)), font, detailSize, healthColor, healthBackgroundColor, healthTextColor), curTextBarBlock);
			miniGameMenuPage->addBox(new TextBox(MiniGameCharacterBoxPreset(count, true, "DEF: "),											ETextBoxFunction_NO_FUNCTION,	UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, maxWidth,		maxHeight / 4, Edges(0,			3,			0, 0)), font, TextBoxSizeInfo(detailSize),  colors), false, curTextBarBlock);
			miniGameMenuPage->addBox(new HealthBox(HealthBoxPreset(			count,		 ECharacterStatBoxValueToDisplay_CHARACTER_DEFENSE),								UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, maxWidth - 50,	maxHeight / 4, Edges(0,			3,			0, 0)), font, detailSize, healthColor, healthBackgroundColor, healthTextColor), curTextBarBlock);
			miniGameMenuPage->addBox(new TextBox(MiniGameCharacterBoxPreset(count, true, "STUNS: "),										ETextBoxFunction_NO_FUNCTION,	UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, maxWidth,		maxHeight / 4, Edges(0,			padding,	0, 0)), font, TextBoxSizeInfo(detailSize),  colors), false, curTextBarBlock);
			miniGameMenuPage->addBox(new TextBox(MiniGameCharacterBoxPreset(count, true, ECharacterStatBoxValueToDisplay_CHARACTER_STUN),	ETextBoxFunction_NO_FUNCTION,	UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_TOP, maxWidth - 50,	maxHeight / 4, Edges(0,			padding,	0, 0)), font, TextBoxSizeInfo(detailSize), colors), false, curTextBarBlock);
...
void createMiniGameCharacterSelectionMenu(MenuManager& menuManager, const ScreenObject& screen, MiniGameWorldData& worldData)
{
	...
	if (worldData.getStage()->mGrid.isSetUp())
	{
		...
		for (int countCharacter = 0; countCharacter < combatManager.getAllCharacters().size(); countCharacter++)
		{
			...
			miniGameMenuPage->addBox(new TextBox(MiniGameCharacterBoxPreset(								countCharacter, characterType, true, ECharacterStatBoxValueToDisplay_CHARACTER_NAME,	whenToShow), ETextBoxFunction_ATTACK_CHARACTER_BOX, UIPositionInfo(EUIPositionAlign_LEFT, EUIPositionAlign_CENTER, panelWidth,	panelBodyHeight / 4,	Edges()), font, TextBoxSizeInfo(optionText, optionText + 5, 2), optionBox), true, pCharacterSelectionPanel);
		}
	}
	...
	if (worldData.mCurLevelNumber != -1)
	{
		...
		for (int countCharacter = 0; countCharacter < (int)combatManager.getAllCharacters().size(); countCharacter++)
		{
			...
			for (int countAttack = 0; countAttack < (int)attacks.size(); countAttack++)
			{
				...
				// bullet, name
				// spacer, details
				UIBlock* bulletAndAttackDetails	= new UIBlock(panelWidth, panelBodyHeight, EUIPositionAlign_LEFT, EUIPositionAlign_TOP, EDirection_RIGHT, EDirection_DOWN, false, 2, !fill, !fill, Edges(0, 0, 0, 0), 0, clear, "Attack bullet and details block");
				...
				UIBlock* pAttackDetailBlock		= new UIBlock(panelWidth, panelBodyHeight, EUIPositionAlign_LEFT, EUIPositionAlign_TOP, EDirection_RIGHT, EDirection_DOWN, false, 1, !fill, !fill, Edges(5, 7, 0, 0), 0, clear, "attack details");
...
void createBlockDiagram(const Attack& attack, const int characterIndex, const int attackNum, MenuPage* pPage, UIBlock* pBlock, const std::vector<EMiniGameState>& whenToShow, MenuManager& menuManager)
{
	...
	UIBlock* pDiagramBlock = new UIBlock(200, maxBlockHeight, EUIPositionAlign_LEFT, EUIPositionAlign_TOP, EDirection_RIGHT, EDirection_DOWN, true, size, !fill, !fill, Edges(0, 0, leftBlockMargin, 0), 0, clear, "block diagram");
	switch(attack.mType)
	{ 
